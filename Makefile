...
BULLET= -I./bullet3/src -I./bullet3/bin $(BULLET_OBJ_FILES) -I./bullet3/Extras/Serialize/BulletFileLoader -I./bullet3/Extras/Serialize/BulletWorldImporter -L./bullet3/Extras/Serialize/BulletWorldImporter/
GLM=-I./glm/
